          ...
          <div className="bg-white rounded-lg shadow border border-gray-200">
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <input type="email" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" value="kerimkarakan@gmail.com" readOnly />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Account Type
